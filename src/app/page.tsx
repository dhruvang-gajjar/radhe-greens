  ...
  return (
    <div className="space-y-3.5 pb-20">
      ...
      <header className="flex items-center justify-between pt-1">
        ...
        <Link
          href="/add"
          className="inline-flex items-center gap-1 px-3.5 py-1.5 rounded-full bg-theme-primary text-white text-xs font-semibold hover:bg-theme-hover transition active:scale-95 shadow-sm"
        >
          <span>+</span> Add Name
        </Link>
      </header>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full bg-white border border-slate-200 rounded-xl pl-10 pr-9 py-2.5 text-base sm:text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-theme-primary focus:ring-1 focus:ring-theme-primary transition shadow-sm"
        />
        {search && (
          <button
            onClick={() => setSearch("")}
              ...
              <div className="mt-1">
                {isOccupied ? (
                  <div className="flex items-center justify-between gap-2">
                    ...
                    {societyConfig.allowEdit && (
                      <Link
                        ...
                        className="inline-flex items-center gap-1 text-[11px] font-medium text-slate-500 hover:text-theme-primary bg-slate-50 hover:bg-theme-light hover:border-theme-border px-2 py-0.5 rounded-md border border-slate-200 transition shrink-0 active:scale-95"
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      href={`/add?block=${m.block}&flat=${m.flatNo}`}
                      className="text-[11px] text-theme-primary font-semibold hover:underline inline-flex items-center gap-1"
                    >
          ...
          <div className="text-center py-12 bg-white rounded-xl border border-slate-200 p-6 space-y-2.5">
            ...
            {!search && (
              <div className="pt-2">
                <Link
                  href="/add"
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-theme-primary text-white text-xs font-bold hover:bg-theme-hover transition shadow-xs"
                >
